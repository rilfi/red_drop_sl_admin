(function($) {
    ...
    function updateInputValues(inputBinding, gmapContext) {
        ...
        if (inputBinding.latitudeInput) {
            inputBinding.latitudeInput.val(currentLocation.latitude.toFixed(6)).change();
        }
        if (inputBinding.longitudeInput) {
            inputBinding.longitudeInput.val(currentLocation.longitude.toFixed(6)).change();
        }
