    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Manage Blood Donors</h3>
                <div class="card-tools pull-right">
                    <div class="input-group input-group-sm">

                      <div class="input-group-btn">

                        <a href="#" data-what="import_donors_excel" data-form-action="<?php echo base_url('admin/blooddonors/excel_import'); ?>" data-modal="ajaxModal" data-title="Import Donors"
                           class="btn btn-sm btn-info" data-sample-file="<?php echo base_url('uploads/samples/donors_import_sample.xlsx'); ?>"><i
                              class="fa fa-file-import"></i> Import From Excel</a>


                        <a href="#" data-what="add_new_blood_donor" data-modal="ajaxModal" data-title="Add Blood Donor"
                           class="btn btn-sm btn-primary"><i
                              class="fa fa-plus"></i>Add Blood Donor</a>
                      </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="blooddonors_table" class="table table-sm table-hover table-bordered">
                    <thead>
                    <tr>
                        <th>Id</th>
                        <th>Name</th>
...
<script>
    ...
    $(function () {
        ...
        var table = $('#blooddonors_table').DataTable({
            serverSide: true,
            processing: true,
            ajax: {
                url: '<?php echo base_url("admin/blooddonors/get_blooddonors"); ?>',
                type: 'POST',
                "data": function (d) {
                    d.something = "";
                }
        ...
        // $('#blooddonors_table tfoot th:not(:last-child, :nth-last-child(2), :nth-last-child(3))').each(function () {
        //     var title = $(this).text();
