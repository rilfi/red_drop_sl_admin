        ...
        <div class="card">
                ...
                <div class="card-tools pull-right">
                    <div class="input-group input-group-sm">
                        ...
                        <div class="input-group-btn">
                            <a href="#" data-what="add_new_country" data-modal="ajaxModal"
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="countries_table" class="table table-sm table-hover table-bordered">
                    <thead>
                    <tr>
                        <th>Id</th>
                        <th>Name</th>
                    ...
                    <tr>
                        ...
                        <th class=""><input type="text" class="text_filter form-control"
                                            placeholder="Name"></th>
                        <th class=""><input type="text" class="text_filter form-control"
                                            placeholder="Short Name"></th>
                        <th class=""><input type="text" class="text_filter form-control"
                                            placeholder="Phone Code"></th>
                        <th></th>
                    </tr>
                    <tr>
                        <th colspan="5" class="">
...
<script>
    ...
    $(function () {
        ...
        var table = $('#countries_table').DataTable({
            ...
            processing: true,
            ajax: {
                url: '<?php echo base_url("admin/countries/get_countries"); ?>',
                type: 'POST',
                "data": function (d) {
                    d.something = "";
                }
        ...
        // $('#countries_table tfoot th:not(:last-child, :nth-last-child(2), :nth-last-child(3))').each(function () {
        //     var title = $(this).text();
