        ...
        <div class="card">
                ...
                <div class="card-tools pull-right">
                    <div class="input-group input-group-sm">
                        ...
                        <div class="input-group-btn">
                            <a href="#" data-what="add_new_state" data-modal="ajaxModal"
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="states_table" class="table table-sm table-hover table-bordered">
                    <thead>
                    <tr>
                        <th>Id</th>
                        <th>Name</th>
...
<script>
    ...
    $(function () {
        ...
        var table = $('#states_table').DataTable({
            serverSide: true,
            processing: true,
            ajax: {
                url: '<?php echo base_url("admin/states/get_states"); ?>',
                type: 'POST',
                "data": function (d) {
                    d.something = "";
                }
        ...
        // $('#states_table tfoot th:not(:last-child, :nth-last-child(2), :nth-last-child(3))').each(function () {
        //     var title = $(this).text();
