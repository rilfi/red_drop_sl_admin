            ...
            <div id="page-content">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                                    ...
                                    <ul class="wz-icon-bw wz-nav-off">
                                        ...
                                        <li class="col-xs-3">
                                            <a data-toggle="tab" href="#demo-bv-tab4" title="Finish">
                                                <span class="icon-wrap icon-wrap-sm icon-circle bg-success">
                                                <i class="wz-icon fa fa-shopping-cart fa-2x"></i>
                                                <i class="wz-icon-done fa fa-check fa-2x"></i>
                                            </span>
                                            </a>
                                        </li>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="demo-bv-tab3" class="tab-pane">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <input type="text" placeholder="Site name" name="system_name" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-3 control-label">Admin E-mail</label>
                                                    <div class="col-lg-7">
                                                        <input type="text" placeholder="Admin E-mail" name="email" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-3 control-label">Login password</label>
                                                    <div class="col-lg-7">
                                                        <input type="password" placeholder="Login password" name="password" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <select name="currency" onchange="(this.value,this)" class="demo-chosen-select required" data-placeholder="Choose a home_def_currency" tabindex="2" data-hide-disabled="true">
                                                            ...
                                                            <option value="27">Pakistani Rupee</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div id="demo-bv-tab4" class="tab-pane  mar-btm text-center">
                                                ...
                                                <div class="ads" style="display:none;">
                                                    <p class="text-muted">Please click on the follwing link for Activating Your Application. It may cause errors if you do not activate.</p>
                                                    <a class="btn btn-info" style="margin-bottom:7px;" target="_blank" href="https://bit.ly/2GoaF65">Free script`s</a>
                        ...
                        <center> 2019 &copy; All Rights Reserved @ <a href="about:blank">Active Super Shop </a></center>
                    </div>
