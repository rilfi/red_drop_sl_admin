        ...
        <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <a id="btn_img_upload" class='btn btn-lg bg-purple btn-upload'>
                                    ...
                                    <?php echo ucwords('add_image'); ?>
                                    <input type="file" id="img_file_input" name="file"
                                           class="upload-file-input input-post-image-file"
                                           accept=".png, .jpg, .jpeg, .gif"
                                           onchange="$('#input_image_file_label').html($(this).val()); $('#input_image_file_button').show();">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="image-preview">
                                    <img id="img_file_preview" src="#" alt="" class="img-fluid"/>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <?php if (isset($images)) {
                                            foreach ($images as $image): ?>
                                                <div class="col-sm-2 col-file-manager"
                                                     id="img_col_id_<?php echo $image->id; ?>">
            ...
            <div class="modal-footer">
                <div class="file-manager-footer">
                    ...
                    <button type="button" id="btn_img_select" class="btn bg-olive btn-file-select"><i
