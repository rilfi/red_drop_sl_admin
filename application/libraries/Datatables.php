...
//        print_r($this->produce_output(strtolower($output), strtolower($charset)));
...
//            ewodie($this->select, false);
//            ewodie($this->post_columns);

            if (($this->post_columns[$i]['search']['value'] === '0'
                    || $this->post_columns[$i]['search']['value'] === 0
                    || !empty($this->post_columns[$i]['search']['value']))
                && $this->post_columns[$i]['searchable'] == 'true'
